...
public class JavaMapperUpdateByPrimaryKeyWithBLOBsMethodGenerator extends AbstractJavaMapperMethodGenerator {
    @Override
    public void addInterfaceElements(Interface interfaze) {
        ...
        Method method = new Method("updateByPrimaryKeyWithBLOBs");
    ...
    public void addMapperAnnotations(Method method) {
        ...
        OutputUtilities.javaIndent(sb, 1);
        sb.append("\"set ");
        Iterator iter = ListUtilities.removeGeneratedAlwaysColumns(this.introspectedTable.getNonPrimaryKeyColumns()).iterator();
        while(iter.hasNext()) {
