...
public class JavaMapperSelectByParamWithBLOBsMethodGenerator extends AbstractJavaMapperMethodGenerator {
    @Override
    public void addInterfaceElements(Interface interfaze) {
        ...
        Method method = new Method("selectByParamWithBLOBs");
    ...
    public void addMapperAnnotations(Interface interfaze, Method method) {
        ...
        sb.append(".class, method=\"selectByParamWithBLOBs\")");
